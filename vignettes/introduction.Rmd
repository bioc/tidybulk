...
glmmSeq [@ma2020glmmseq] is used for mixed models. Pass `formula_dispersion` as a fixed-effects formula for edgeR tagwise dispersion (you choose whether grouping factors enter that design). Omit it to let each gene estimate phi (useful with many samples).
