...
glmmSeq [@ma2020glmmseq] is used for mixed models. By default tagwise dispersion is estimated with edgeR (`(1 | cell)` becomes `cell`) and plugged in. With many samples, set `plugin_dispersion = FALSE` to let each gene estimate phi.
...
airway |>
  ...
  # Fit model; tagwise dispersion is estimated in the backend
  test_differential_expression(
    ~ dex + (1|cell), 
    method = "glmmseq_lme4", 
    cores = 1,
