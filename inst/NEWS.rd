...
\itemize{
    \item Added \code{estimate_dispersion()}, a \code{SummarizedExperiment} method that writes edgeR tagwise (or trended, above 1000 samples) dispersion and effective degrees of freedom to \code{rowData}, and stores the raw edgeR object in \code{metadata(.)$tidybulk$estimateDisp}.
